...
STATIC_ROOT
  `Default: See below`
  The location of Graphite-web's static content. This defaults to ``static/`` three parent directories up from ``settings.py``. In the :ref:`default layout <default-installation-layout>` this is ``/usr/share/graphite/static``.
  ...
  For Nginx::
      ...
      location /static/ {
          alias /usr/share/graphite/static/;
      }
...
WHISPER_DIR
  `Default: /usr/share/graphite/storage/whisper`
  The location of Whisper data files.

RRD_DIR
  `Default: /usr/share/graphite/storage/rrd`
...
INDEX_FILE
  `Default: /usr/share/graphite/storage/index`
